...
const PokemonModal = ({ isOpen, closeModal, pokemon }) => {
  ...
  const typeColors = {
    ...
    poison: { main: 'bg-violet-900', gradient: 'from-violet-500 via-violet-600 to-violet-500' },
    ...
    fire: { main: 'bg-red-900', gradient: 'from-red-500 via-red-600 to-red-500' },
