...
function CardPokemon({ name, image, stats }) {
  ...
  return (
    <div className={`flex flex-col justify-center items-center  max-w-[240px] bg-[#ddd7d7] rounded-lg shadow-xl border ${stats < 34 ? 'border-red-500 shadow-red-600/20' : stats < 67 ? 'border-yellow-500 shadow-yellow-600/20' : 'border-green-500 shadow-green-600/20'} hover:transform hover:scale-105 hover:shadow-2xl`}>
